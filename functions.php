...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('small', 180, '', true); // Small Thumbnail
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Footer Widget Area', 'html5blank'),
        'description' => __('Widgets for the Footer', 'html5blank'),
        'id' => 'footer_widgets',
...
add_action('init', 'create_post_type_vente'); // Add our HTML5 Blank Custom Post Type
add_action('init', 'create_post_type_promotion'); // Add our HTML5 Blank Custom Post Type
add_action('init', 'create_post_type_realisation'); // Add our HTML5 Blank Custom Post Type
add_action('init', 'create_post_type_slide'); // Add our HTML5 Blank Custom Post Type
